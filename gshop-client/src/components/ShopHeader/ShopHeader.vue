<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isSupportsShow=true">
      ...
      <div class="activity-sheet" v-show="isSupportsShow">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close">
            <span class="iconfont icon-close" @click="isSupportsShow=false"></span>
          </div>
        </div>
