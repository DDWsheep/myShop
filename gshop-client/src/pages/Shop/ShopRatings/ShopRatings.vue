        ...
        <ul>
          <li class="rating-item"
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.type===0?'icon-thumb_up':'icon-thumb_down '"></span>
...
<script>
  ...
  export default {
    data () {
      return {
        selectRateType: 2, //1 不满意 0 满意 2 全部
        onlyContent: false, //只显示有文本内容的
      }
    },
    mounted () {
    ...
    methods: {
      setSelectRateType (selectRateType) { //设置selectRateType的新值
